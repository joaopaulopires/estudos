 ...
 * @author 55139
 */
public class pacoteClasses extends javax.swing.JFrame {

    /**
     * Creates new form pacoteClasses
     */
    public pacoteClasses() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(pacoteClasses.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new pacoteClasses().setVisible(true);
            }
        });
    }
